 ...
 *   (control endpoint, obligatory, as per specification).
 */
...
/**
 * @brief Call when an invalid packet has been sent by the host
 */
...
/**
 * @brief Call to stall execution until current bank is free
 */
